...
def get_md_l3(input_csv):
    with open(input_csv, mode="r", encoding=encoding) as csv_file:
        ...
        for row in reader:
            ...
            prerequis_obligatoires = process_value(row.get("Pré-requis obligatoires", ""))
            ...
            competences_requises = process_value(row.get("Compétences Requises", ""))
...
md_l3_s1 = get_md_l3("L3S1.csv")
md_l3_s2 = get_md_l3("L3S2.csv")
...
with open("L3.md", mode="w", encoding="utf-8") as md_file:
    md_file.write(preamble.format("Licence 3 MIAGE"))
    md_file.write("\\chapter{Premier semestre}\n")
    md_file.write("\n".join(md_l3_s1))
    md_file.write("\\chapter{Deuxième semestre}\n")
    md_file.write("\n".join(md_l3_s2))
